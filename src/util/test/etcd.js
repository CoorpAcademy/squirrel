...
test('isDirectory should return false on null', t => t.deepEqual(isDirectory(), false));

test('isDirectory should return false on file', t => t.deepEqual(isDirectory({}), false));

test('isDirectory should return true on directory', t =>
  t.deepEqual(isDirectory({dir: true}), true));

test('isFile should return false on null', t => t.deepEqual(isFile(), false));
